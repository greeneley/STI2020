...
//TODO Q6)
		digest [i + 4] = (unsigned char) ((context->regs.B >> ((i + 4)*8)) & 0xFF);
		digest [i + 8] = (unsigned char) ((context->regs.C >> ((i + 8)*8)) & 0xFF);
		digest [i + 12] = (unsigned char) ((context->regs.D >> ((i + 12)*8)) & 0xFF);
	}
}	
