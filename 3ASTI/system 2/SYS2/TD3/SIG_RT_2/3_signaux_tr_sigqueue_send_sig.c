...
/*lire les chaines caractere de premier  arguments, transformer en decimal, le resultat pour stocker dedans. ON transforme des valeur caractere dans valeur numerique ( atoi)
*/				usage(argv[0]);
