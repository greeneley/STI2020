...
public class Rectangle extends Quadrilatere {
	...
	/** Créer un constructeur dans la classe Rectangle qui permet d’instancier un
	 *  rectangle non trivial à partir de deux points 
	 *  (sommets opposés du rectangle – on fait l’hypothèse que les segments
	 *   du rectangle sont parallèles aux axes du repère)
	 * 
	 */
	...
	public double getPerimetre(){
		...
		System.out.println("Calcul du périmetre d'un rectangle (de Rectangle)");
